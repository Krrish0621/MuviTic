...
**Live at ** 👉 [LINK](https://muvitic.vercel.app/)
...
**MuviTic** is a modern, full-stack movie ticket booking application built with the MERN stack. It provides users with a seamless experience to discover movies, book tickets, and manage their bookings while offering administrators powerful tools to manage shows, bookings, and movie listings.
...
1. **Clone the repository**
   ```console
   git clone https://github.com/elyse502/MuviTic.git
   cd MuviTic
   ```
...
4. **Environment Configuration**
   ...
   **Server (.env)**
   ```env
   # 🌐 Database
   MONGODB_URI=mongodb://localhost:27017/muvitic
...
For support, email krrishchaturvediofficial@gmail.com or create an issue in the GitHub repository.

---

## 📞 Contact
For any questions or support, please contact:
[Github](https://github.com/Krrish0621) | [Linkedin](https://www.linkedin.com/in/krrish-chaturvedi/) | 
---

<div align="center">

**Made with ❤️ by <i>[Krrish Chaturvedi](https://krrish-chaturvedi-portfolio.vercel.app/)</i>**
