...
const ListBookings = () => {
  ...
  return !isLoading ? (
    <>
      ...
      <div className="mt-6 flex max-w-6xl flex-col gap-4 rounded-3xl border border-white/10 bg-white/[0.055] p-4 backdrop-blur-xl md:flex-row md:items-center md:justify-between">
        <div>
